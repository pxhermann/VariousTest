...
#region properties
        ...
        public string TextValue
        {
            ...
            set { lblText.Text = tbText.Text = value; }
        }
        private bool textEditable = false;
        [Description("Determines whether text in text box can be edited or must be selected from tree")]
        public bool TextEditable
        {
            get { return textEditable; }
            set { textEditable = value; lblText.Visible = !value; tbText.Visible = value; }//TreeBox_StateChanged(null, null); }
        }
#endregion
...
#region design related methods
        ...
        void TreeBox_StateChanged(object sender, EventArgs e)
        {
            ...
            if ( Enabled )
            {
                ...
                lblText.BackColor = tbText.BackColor = Focused ? SystemColors.Highlight : SystemColors.Window;
                lblText.ForeColor = tbText.ForeColor = Focused ? SystemColors.HighlightText : SystemColors.WindowText;
            }
            else
            {
                panelTop.BackColor = lblText.BackColor = tbText.BackColor = SystemColors.Control;
                lblText.ForeColor = tbText.ForeColor = SystemColors.ControlDark;
            }
        }
